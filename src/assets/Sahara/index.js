...
export default {
  ...
  description: [
    ...
    'Michel and I were the two main React guys from then on and we worked on a number of projects together. Screenshots from a lot of my/our work there is included here.',
    ...
    'Neighbor, used to be called Neiybor, is simply the AirBnB of storage. Moving on. Pritchett Bridal: we finished in about a week and then we never saw it go online. Somehow, magically, it’s up now and it’s changed a bit. The1Million was an app my team of 4-7 (depending on if you include an intern, a sales bro, & PM) completely in the span of 24 hours. We had this challenge day called ‘App Day’ where different teams worked 24 hours on an app to complete it and win prizes at the end. Needless to say, we won that competition. The idea was simple, get 1 million people to pledge 1 dollar a month to a charity. If they could reach that goal, they would be donating $1 million to a charity every month.',
    'Sahara was just the home site for the company I worked for. They put a frail little intern on the project with one of the founders to finish the site. We did a dang good job thought and if anything bad happened to the company, it wasn’t because of the website.',
    'Finally, BugClub was a weird idea to take all those subscription boxes and business model, but cater it to fly-fishermen. I didn’t think it was going anywhere, but we were pressured to finish the site, which we did in probably 2 weeks. (The designs were horrible and a pain and I can say that now without feeling bad.) Anyways, it’s obviously not up on the internet so I screenshot what I had and put it on Imgur.',
